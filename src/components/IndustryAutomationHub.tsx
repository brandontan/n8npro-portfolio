...
import { ChevronLeft, ChevronRight, ShoppingCart, Scale, Calculator, Building2, Heart, Factory, Database, Cloud, Zap, CheckCircle, Webhook, Sparkles, Mail, BarChart, FileText, Calendar, Clock, Users, DollarSign, Package, Brain, Globe, Send, Bell, Activity, Lock, Sparkle, ExternalLink } from "lucide-react"
                          ...
                          {sln.liveDemo && (
                            <div className="mt-4">
                              <a 
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-200 font-medium"
                              >
