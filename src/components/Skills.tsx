  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "AI-powered Decision Engines", level: 68 },
        { name: "Dynamic Content Generation", level: 65 },
        { name: "Intelligent Routing & Scoring", level: 70 },
        { name: "NLU/NLP Processing", level: 62 },
      ],
    },
    {
      icon: Zap,
      ...
      skills: [
        { name: "Workflow Orchestration", level: 72 },
        { name: "API Integration & Webhooks", level: 70 },
        { name: "Data Pipeline Automation", level: 68 },
        { name: "Real-time Event Processing", level: 65 },
      ],
    },
    {
      icon: Layers,
      ...
      skills: [
        { name: "Large Language Models (LLMs)", level: 67 },
        { name: "RAG Systems & Vector DBs", level: 60 },
        { name: "CRM & Business Tool Integration", level: 70 },
        { name: "AI Model Deployment & APIs", level: 63 },
      ],
    },
  ];
